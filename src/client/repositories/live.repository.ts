...
export class LiveRepository extends Repository {
  public async muteComment(
    broadcastId: string
  ): Promise<LiveSwitchCommentsResponseRootObject> {
    const { body } =
      await this.client.request.send<LiveSwitchCommentsResponseRootObject>({
  ...
  public async getComment({
    ...
    const { body } =
      await this.client.request.send<LiveCommentsResponseRootObject>({
  ...
  public async heartbeatAndGetViewerCount(
    broadcastId: string
  ): Promise<LiveHeartbeatViewerCountResponseRootObject> {
    const { body } =
      await this.client.request.send<LiveHeartbeatViewerCountResponseRootObject>(
        {
  ...
  public async getFinalViewerList(
    broadcastId: string
  ): Promise<LiveFinalViewersResponseRootObject> {
    const { body } =
      await this.client.request.send<LiveFinalViewersResponseRootObject>({
  ...
  public async create({
    ...
    const { body } =
      await this.client.request.send<LiveCreateBroadcastResponseRootObject>({
  ...
  public async getViewerList(
    broadcastId: string
  ): Promise<LiveViewerListResponseRootObject> {
    const { body } =
      await this.client.request.send<LiveViewerListResponseRootObject>({
  ...
  public async getQuestions(): Promise<LiveGetQuestionsResponseRootObject> {
    const { body } =
      await this.client.request.send<LiveGetQuestionsResponseRootObject>({
  ...
  public async like(
    broadcastId: string,
    likeCount: number = 1
  ): Promise<LiveLikeResponseRootObject> {
  ...
  public async getLikeCount(
    ...
    const { body } =
      await this.client.request.send<LiveLikeCountResponseRootObject>({
  ...
  public async getPostLiveThumbnails(
    broadcastId: string
  ): Promise<LivePostLiveThumbnailsResponseRootObject> {
    const { body } =
      await this.client.request.send<LivePostLiveThumbnailsResponseRootObject>({
  ...
  public async resumeBroadcastAfterContentMatch(
    broadcastId: string
  ): Promise<any> {
    // TODO: test
    const { body } = await this.client.request.send({
  ...
  public async getJoinRequestCounts({
    ...
    const { body } =
      await this.client.request.send<LiveJoinRequestCountsResponseRootObject>({
  ...
  public async start(
    ...
    const { body } =
      await this.client.request.send<LiveStartBroadcastResponseRootObject>({
  ...
  public async addPostLiveToIgtv({
    ...
    const { body } =
      await this.client.request.send<LiveAddPostLiveToIgtvResponseRootObject>({
