...
export class DirectThreadRepository extends Repository {
  ...
  public async approveParticipantRequests(
    ...
    const { body } =
      await this.client.request.send<DirectThreadRepositoryApproveParticipantRequestResponseRootObject>(
        {
  ...
  public async getByParticipants(
    ...
    const { body } =
      await this.client.request.send<DirectThreadRepositoryGetByParticipantsResponseRootObject>(
        {
  ...
  public async updateTitle(
    ...
    const { body } =
      await this.client.request.send<DirectThreadRepositoryUpdateTitleResponseRootObject>(
        {
  ...
  public async addUser(
    ...
    const { body } =
      await this.client.request.send<DirectThreadRepositoryAddUserResponseRootObject>(
        {
  ...
  public async broadcast(
    ...
    const form = {
      ...
      [recipientsType]: JSON.stringify(
        recipientsType === 'thread_ids' ? recipientsIds : [recipientsIds]
      ),
    ...
    const { body } =
      await this.client.request.send<DirectThreadRepositoryBroadcastResponseRootObject>(
        {
