...
export class FeedFactory {
  ...
  public musicTrending(product: IgAppModule = 'story_camera_music_overlay_post_capture'): MusicTrendingFeed {
    return plainToClassFromExist(new MusicTrendingFeed(this.client), {
      product,
    })
  }
  ...
  public postsInsightsFeed(options: PostsInsightsFeedOptions) {
    return plainToClassFromExist(new PostsInsightsFeed(this.client), {
      options,
    })
  }

  public storiesInsights(timeframe: 'ONE_DAY' | 'ONE_WEEK' | 'TWO_WEEKS') {
    return plainToClassFromExist(new StoriesInsightsFeed(this.client), {
      timeframe,
    })
  }
  ...
  public listReelMediaViewers(mediaId: string): ListReelMediaViewerFeed {
    return plainToClassFromExist(new ListReelMediaViewerFeed(this.client), {
      mediaId,
    })
  }
